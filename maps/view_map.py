...
def load_map(path):
    ...
    with open(os.path.join(path, 'graph'), 'rb') as graph_file:
        ...
        for anchored_world_object in current_graph.anchoring.objects:
            ...
            pos = anchored_world_object.seed_tform_object.position
            ori = anchored_world_object.seed_tform_object.rotation
            # pretty_print_waypoints(ori)
            print("id: {} x: {} y: {} z: {}".format(anchored_world_object.id, pos.x, pos.y, pos.z))
            print("id: {} x: {} y: {} z: {} w: {}".format(anchored_world_object.id, ori.x, ori.y, ori.z, ori.w))
