...
class WasdInterface(object):
    ...
    def _drive_draw(self, stdscr, lease_keep_alive):
        ...
        stdscr.addstr(11, 0, '          [T]: Time-sync, [ESC]: Estop, [P]: Power')
        stdscr.addstr(12, 0, '          [f]: Stand, [r]: Self-right               ')
        stdscr.addstr(13, 0, '          [v]: Sit, [b]: Battery-change             ')
        stdscr.addstr(14, 0, '          [wasd]: Directional strafing              ')
        stdscr.addstr(15, 0, '          [qe]: Turning, [SPACE]: Stop                ')
